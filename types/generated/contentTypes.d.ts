...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  attributes: {
    ...
    References: Attribute.RichText &
      ...
      >;
    article_group: Attribute.Relation<
      'api::article.article',
      'manyToOne',
      'api::article-group.article-group'
    >;
...
export interface ApiArticleGroupArticleGroup extends Schema.CollectionType {
  ...
  attributes: {
    Name: Attribute.String & Attribute.Required;
    slug: Attribute.UID<'api::article-group.article-group', 'Name'> &
      Attribute.Required;
...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    article_groups: Attribute.Relation<
      'api::category.category',
      'oneToMany',
      'api::article-group.article-group'
    >;
...
export interface ApiMainCategoryMainCategory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::main-category.main-category', 'Name'> &
      Attribute.Required;
...
export interface ApiReviewerReviewer extends Schema.CollectionType {
  ...
  attributes: {
    Name: Attribute.String & Attribute.Required;
    slug: Attribute.UID<'api::reviewer.reviewer', 'Name'> & Attribute.Required;
    bio: Attribute.Text & Attribute.Required;
    reviewer_slug: Attribute.String & Attribute.Required & Attribute.Unique;
    articles: Attribute.Relation<
      'api::reviewer.reviewer',
      'oneToMany',
      'api::article.article'
    ...
    Links: Attribute.Text &
      Attribute.DefaultTo<'https://salamy.com/users/Mahmoudgalal, https://salamy.com/users/brandria,'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiSupportCenterSupportCenter extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Opereation: Attribute.String & Attribute.Required;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::article-group.article-group': ApiArticleGroupArticleGroup;
